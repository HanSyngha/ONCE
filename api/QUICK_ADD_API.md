...
```bash
curl "http://a2g.samsungds.net:16001/api/quick-add/search?id=hong.gildong&q=마케팅+예산+회의"
```
...
```bash
# 전체 Todo 조회
curl "http://a2g.samsungds.net:16001/api/quick-add/todos?id=hong.gildong"

# 2월 Todo만 조회
curl "http://a2g.samsungds.net:16001/api/quick-add/todos?id=hong.gildong&startDate=2026-02-01&endDate=2026-02-28"
```
...
```bash
# Todo 완료 처리
curl -X PATCH http://a2g.samsungds.net:16001/api/quick-add/todos \
  -H "Content-Type: application/json" \
...
# 내 Todo 확인
curl "http://a2g.samsungds.net:16001/api/quick-add/todos?id=syngha.han"

# 검색
curl "http://a2g.samsungds.net:16001/api/quick-add/search?id=syngha.han&q=프로젝트+일정"
